...
On the danish side you will have to work with the closest [ICS](https://lifeindenmark.borger.dk/housing-and-moving/ics-international-citizen-service). They perform the  

The checklist outlines the main things one has to apply for when wanting to stay over 6 months:

1. CPR Number
    - You will not be insured unless you have this! (I think).
1. Tax Card
...
1. NemID / NemKonto
    ...
    - WIP: I'm still not sure how I'm gonna do this, I think I'll get a Danish bank account and designate that as my NemKonto, but technically assigning my current German bank should also be possible.
1. A-Konto
    - *Arbeitslosenkasse*: if you lose your job, this is a separate insurance you can *chose* to pay to get money while looking for a new job, the rates seem to be quite low, so it seems it only makes sense to sign up to one.
